  ...
  return (
    <div className="bg-[#e0e1dd] flex flex-col sm:flex-row justify-center w-screen h-screen">
      ...
      <div className="basis-1/2 bg-[#D3D3D3] flex flex-col justify-center items-center">
        ...
        <div  className="relative w-64">
            <input type="email" id="password" className="bg-gray-50 border border-gray-500 text-gray-900 text-sm rounded focus:ring-blue-500 focus:border-blue-500 block w-64 h-12 p-2 m-2" placeholder="Password" required />
            <span className="absolute inset-y-0 right-0 flex items-center pr-2 pointer-events-none">
        ...
        <div>
          ...
          <div className=" mb-2 text-xs p-3" >
            <p>
              <span className="  text-gray-500">Already have an account yet? </span>
